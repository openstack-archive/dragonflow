...
DEFAULT_APPS_LIST="portbinding,l2,l3_proactive,dhcp,dnat,portqos,classifier,tunneling,provider"
...
function configure_df_plugin {
    ...
    cp $DRAGONFLOW_DIR/etc/etc/dragonflow_datapath_layout.yaml $DRAGONFLOW_CONF
