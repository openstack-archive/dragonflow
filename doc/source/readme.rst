...
::
   ...
   Q_DF_CONTROLLER_IP='<your sdn controller ip>' (Optinal, Default == $HOST_IP)

   Q_DF_CONTROLLER_PROTOCOL= tcp/ssl (Optinal, Default == tcp)

   Q_DF_CONTROLLER_PORT= <port number> (Optinal, Default == 6633)
