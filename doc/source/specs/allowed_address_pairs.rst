...
A smarter way is sending those packets only to the ports of the VMs who
...
ARP table, or we could only use the detected MAC address of the active VM's
port to reply ARP requests, if the active VMs mentioned above was detected.
