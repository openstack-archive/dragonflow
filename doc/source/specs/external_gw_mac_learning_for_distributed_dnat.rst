...
The above blueprint describes how to implement distributed DNAT in Dragonflow.
As a supplement, this spec will describe the work flow further and introduce
a solution to learn external gateway mac dynamically.
