...
NB-API layer and re-sync the object from Neutron DB and also need to guarantee
the data is synced to all the DF DB. There will be a follow-up patch for solving
such a problem.
