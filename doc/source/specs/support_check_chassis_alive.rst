...
false, ml2 port binding can switch to use another Chassis. The details depends
on the implementation of other functionalities. This method just provides the
