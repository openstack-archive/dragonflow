...
For three types, drangonflow controller will handle differently.
...
With unkown outside servers, thus will be treated as common broadcast.
...
controller acts as dhcp server to repond for dhcp request.
If 'dhcp enalbe' option is off,dhcp broadcast is treated as common broadcast.
Actually it's same as what vxlan network does.
