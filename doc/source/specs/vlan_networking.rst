...
and fowarded to outside through host's physical nic.
...
it will handle them just as what it does for does, and install flows.
...
Here we just talk about two mainly used topologies.
