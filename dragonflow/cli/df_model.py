...
class ModelsPrinter(object):
    ...
    def handle_field(self, field_name, field_type, is_required, is_embedded,
        ...
        :param is_required: boolean - True iff the field is a required field
        for the specific model
        :param is_embedded: boolean - True iff the field is not a reference
        to another object, but rather an object that is part of the model
        :param is_single: boolean - True iff the field is single-valued
        :param restrictions: string - representation of any restrictions on
        the field (e.g. list of possible values for enum)
        """
        pass
    ...
    def handle_index(self, index_name):
        ...
        :param index_name: string - the name of the index field
        """
        pass
