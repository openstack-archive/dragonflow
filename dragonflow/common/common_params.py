...
DF_OPTS = [
    ...
    cfg.BoolOpt('enable_neutron_listener',
                default=True,
                help=_('Enable Dragonflow controllers to send notifications'
                       'e.g port status, and enable neutron-server to'
                       'register as a listener to receive notifications')),
    ...
    cfg.IntOpt('neutron_listener_report_delay',
        default=3,
        help=_('The max delay for Neutron to report heart beat to df-db'))
]
