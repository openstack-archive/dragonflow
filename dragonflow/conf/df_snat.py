...
df_snat_app_opts = [
    ...
    cfg.BoolOpt('tenant_separation', default=False,
        help=_("Set True to enable separate external address per tenant, "
               "otherwise single external address per compute host 'host_ip' "
               "would be used.")),
]
