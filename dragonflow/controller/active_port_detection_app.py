...
DF_ACTIVE_PORT_DETECTION_APP_OPTS = [
...
class ActivePortDetectionApp(df_base_app.DFlowApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        cfg.CONF.register_opts(DF_ACTIVE_PORT_DETECTION_APP_OPTS,
                               group='df_active_port_detection_app')
        self.dection_interval_time = \
            cfg.CONF.df_active_port_detection_app.detection_interval_time
