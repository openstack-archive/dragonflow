...
class TrunkApp(df_base_app.DFlowApp):
    ...
    def __init__(self, api, vswitch_api=None, nb_api=None,
        ...
        super(TrunkApp, self).__init__(api, vswitch_api=vswitch_api,
                nb_api=nb_api,
    ...
    def _install_local_cps(self, child_port_segmentation):
        LOG.debug('_install_local_cps: %s', child_port_segmentation)
        segmentation_type = child_port_segmentation.segmentation_type
        try:
            implementations = self.segmentation_type_implementations[
                    segmentation_type]
        except KeyError:
