...
LoadedDatapath = collections.namedtuple('LoadedDatapath', ('apps',))
    # Duck:
    #   self.apps: dictionary: vertex name -> app duck
    #   app duck:
    #       states:      attr dict: state name -> table number
    #       entrypoints: attr dict: entry name -> table number
    #       exitpoints:  attr dict: exit name -> table number
    #       full_mapping:attr dict: var name -> reg name
    #   All dicts are attribute dicts
