...
from dragonflow.controller.df_db_objects_refresh import DfObjectRefresher
...
class DfLocalController(object):
    ...
    def run_db_poll(self):
        try:
            ...
            # TODO(snapiri): Use object refresher for tunnels too? 
            self.create_tunnels()
