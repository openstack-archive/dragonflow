...
class DfLocalController(object):
    ...
    def _register_old_model_consistency_handlers(self):
    ...
    def _register_models(self):
        ...
        self._register_old_model_consistency_handlers()

        for model in model_framework.iter_models():
            # FIXME do not register topicless models for now
            if issubclass(model, mixins.TopicMixin):
