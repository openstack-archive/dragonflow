...
from dragonflow.switch.drivers import df_ovs_driver
...
class DfLocalController(object):
    ...
    def __init__(self, chassis_name, nb_api):
        ...
        # FIXME(snapiri) we currently have an issue with the dynamic loading
        # This is a patch to make sure we did not break anything
        # http://paste.openstack.org/show/xoaWC5vMC1yWJUi0AzDN/
        self.switch_backend = df_ovs_driver.DfOvsDriver(
