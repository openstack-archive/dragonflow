...
class DHCPApp(DFlowApp):
    ...
    def OF_packet_in_handler(self, event):
        ...
        lport = self.db_store.get_port_by_tunnel_key(port_tunnel_key)
        if lport is None:
            LOG.error(
    ...
    def _create_dhcp_ack(self, pkt, dhcp_packet, lport):
        ...
        #domain_name_bin = struct.pack('!s', self.domain_name)
        ...
        #dhcp.option(tag=15, value=domain_name_bin)]
    ...
    def _create_dhcp_offer(self, pkt, dhcp_packet, lport):
        ...
        #dhcp.option(tag=15, value="openstacklocal")]
