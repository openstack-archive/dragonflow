...
class DHCPApp(df_base_app.DFlowApp):
    ...
    def _create_dhcp_packet(self, pkt, dhcp_packet, pkt_type, lport):
        ...
        gateway_address = self._get_port_gateway_address(subnet).packed
        ...
        option_list = [
            ...
            dhcp.option(dhcp.DHCP_GATEWAY_ADDR_OPT, gateway_address),
        ...
        dhcp_pkt.add_protocol(udp.udp(src_port=67, dst_port=68))
