...
class DNATApp(DFlowApp):
    ...
    def packet_in_handler(self, event):
        ...
        if arp_pkt.opcode == arp.ARP_REPLY:
            fip1 = self.db_store.get_floatingip_by_ip(arp_pkt.dst_ip)
            fip2 = self.db_store.get_floatingip_by_gateway(arp_pkt.src_ip)
            ...
            fip = self.db_store.get_floatingip_by_gateway(arp_pkt.dst_ip)
