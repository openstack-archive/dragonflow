...
class DNATApp(df_base_app.DFlowApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.floatingip_rarp_cache = {}  # FIXME rename
    ...
    def _handle_ingress_icmp_translate(self, event):
        ...
        floatingip = self.floatingip_rarp_cache.get(port_key)
        ...
        self.mod_flow(
            ...
            inst=[
                parser.OFPInstructionActions(
                    ...
                    self._get_ingress_nat_actions(floatingip) + [
    ...
    def _install_egress_nat_rules(self, floatingip):
        ...
        self.mod_flow(
            ...
            inst=[
                parser.OFPInstructionActions(
                    ofproto.OFPIT_APPLY_ACTIONS,
                    self._get_egress_nat_actions(floatingip) + [
                        parser.NXActionResubmitTable(
                            table_id=const.L2_LOOKUP_TABLE,
                        )
                    ],
    ...
    def _associate_floatingip(self, floatingip):
        ...
        port_key = floatingip.lport.unique_key
        self.floatingip_rarp_cache[port_key] = floatingip
    ...
    def _disassociate_floatingip(self, floatingip):
        ...
        port_key = floatingip.lport.unique_key
        self.floatingip_rarp_cache.pop(port_key, None)
