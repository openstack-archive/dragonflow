...
class DNATApp(DFlowApp):
    ...
    def _waite_for_external_network_bridge_mac(self):
    ...
    def _init_external_network_bridge_check(self):
        ...
        periodic = loopingcall.FixedIntervalLoopingCall(
            self._waite_for_external_network_bridge_mac)
    ...
    def associate_floatingip(self, floatingip):
        self.local_floatingips[floatingip.name] = floatingip
    ...
    def disassociate_floatingip(self, floatingip):
        if floatingip.name in self.local_floatingips:
            del self.local_floatingips[floatingip.name]
