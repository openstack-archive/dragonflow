...
class L2App(DFlowApp):
    ...
    def _install_network_flows_on_first_port_up(self,
                                                segmentation_id,
                                                local_network_id):
        LOG.info("Install network flows on frist port up.")
    ...
    def _install_network_flows_for_tunnel(self,
                                          segmentation_id,
                                          local_network_id):
        LOG.info("Install network flows for tunnel.")
    ...
    def _add_multicast_broadcast_handling_for_local_port(self,
        ...
        match.set_dl_dst_masked(addint, addint)
        match.set_metadata(network_id)
        egress_inst = [parser.OFPInstructionActions(ofproto.OFPIT_APPLY_ACTIONS,
                                                    egress)]
        self.mod_flow(
            self.get_datapath(),
            inst=egress_inst,
