...
class RyuDFAdapter(ofp_handler.OFPHandler):
    ...
    def notify_update_qos(self, qos):
        self.dispatcher.dispatch('update_qos', qos)

    def notify_delete_qos(self, qos):
        self.dispatcher.dispatch('delete_qos', qos)
