...
class SGApp(df_base_app.DFlowApp):
    ...
    def _install_flows_from_address_list(self, addresses_list, ethertype,
        ...
        for cidr_item in addresses_list:
            if (cidr_item is "") or netaddr.IPNetwork(cidr_item).version == \
    ...
    def _update_security_group_rule_flows_by_addresses(self,
        ...
        self._install_flows_from_address_list(addresses_list=added_cidr,
                                            ethertype=ethertype,
                                            inst=inst,
                                            table_id=table_id,
                                            priority=priority,
        ...
        self._install_flows_from_address_list(addresses_list=removed_cidr,
                                            ethertype=ethertype,
                                            table_id=table_id,
                                            priority=priority,
                                            rule_id=rule_id,
