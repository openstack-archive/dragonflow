...
class Topology(object):
    ...
    def _pull_tenant_topology_from_db(self, tenant_id=None, lport_id=None):
        ...
        :param lport_id:  The id of logical port, which will not be applied to
                          ...
                          to local.
        """
        switches_to_remove = list(self.db_store.get_lswitch_keys(tenant_id))
        ...
        sgs_to_remove = list(self.db_store.get_security_group_keys(tenant_id))
        ...
        ports_to_remove = list(self.db_store.get_port_keys(tenant_id))
        ...
        routers_to_remove = list(self.db_store.get_router_keys(tenant_id))
        ...
        fips_to_remove = list(self.db_store.get_floatingip_keys(tenant_id))
