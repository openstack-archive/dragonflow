...
class Topology(object):
    ...
    def _vm_port_updated(self, ovs_port):
        ...
        self.ovs_to_lport_mapping[ovs_port_id] = {'lport_id': lport_id,
                                                  'topic': topic}
        # In the case when df controller is running and the topic topology has
        # been pulled, a new vm port online will not have record in db_store.
        if not self.db_store.get_port(lport_id):
