...
class NbApi(object):
    ...
    def __init__(self, driver, db_driver, use_pubsub=False,
    ...
    def _server_start_subscriber(self):
        self.subscriber.initialize(self.port_status_callback)
        server_ip = cfg.CONF.df.local_ip
        server_topic = server_ip + db_common.PORT_STATUS_TOPIC
        self.driver.create_key('portstats', 'port_status',
                               server_topic, server_ip)
