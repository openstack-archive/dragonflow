...
class NbApi(object):
	...
	state_json = jsonutils.dumps(port_state)
        self.driver.create_key('lport_state', port_id, state_json)

    def get_lport_state(self, port_id):
        state_json = self.driver.get_key('lport_state', port_id)
	port_state = jsonutils.loads(state_json)
        return port_state

    def clear_lport_state(self, port_id):
        self.driver.delete_key('lport_state', port_id)
