...
class CassandraDbDriver(db_api.DbApi):
    ...
    def _get_consistency_level(self, consistency_level):
        ...
        if consistency_level == 'any':
            return query.ConsistencyLevel.ANY
        elif consistency_level == 'one':
            return query.ConsistencyLevel.ONE
        elif consistency_level == 'two':
            return query.ConsistencyLevel.TWO
        elif consistency_level == 'three':
            return query.ConsistencyLevel.THREE
        elif consistency_level == 'quorum':
            return query.ConsistencyLevel.QUORUM
        elif consistency_level == 'all':
            return query.ConsistencyLevel.ALL
        elif consistency_level == 'local_quorum':
            return query.ConsistencyLevel.LOCAL_QUORUM
        elif consistency_level == 'each_quorum':
            return query.ConsistencyLevel.EACH_QUORUM
        elif consistency_level == 'serial':
            return query.ConsistencyLevel.SERIAL
        elif consistency_level == 'local_serial':
            return query.ConsistencyLevel.LOCAL_SERIAL
        elif consistency_level == 'local_one':
            return query.ConsistencyLevel.LOCAL_ONE
        else:
            # by default
            return query.ConsistencyLevel.LOCAL_ONE
