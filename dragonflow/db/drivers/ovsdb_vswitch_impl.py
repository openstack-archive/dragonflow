    ...
    def handle_message(self):
        while True:
            ...
            try:
                ...
                LOG.exception(_LE("exception happened when read from socket, %s"), e)
                return
            ...
            if msg is None:
                ...
                try:
                    ...
                    LOG.exception(_LE("exception happened when send msg, %s"), e)
                    return
    ...
    def run(self):
        while True:
            ...
            try:
                ...
                LOG.exception(_LE("exception happened when send monitor request, %s"), e)
                continue
