...
class ZookeeperDbDriver(db_api.DbApi):
    ...
    def initialize(self, db_ip, db_port, **args):
        self.client = KazooClient(hosts='%s:%d' % (db_ip, db_port),
    ...
    def _generate_path(self, table, key):
        self.client.ensure_path(ROOT_NS + '/' + table)
        if key:
    ...
    def register_notification_callback(self, callback):
        ...
        #                 Please set 'use_df_pub)sub=True' in the configuration
