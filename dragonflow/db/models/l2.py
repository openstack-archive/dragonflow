...
class LogicalPort(mf.ModelBase, mixins.Name, mixins.Version, mixins.Topic,
    ...
    binding_profile=df_fields.StringDictField()
    ...
    def __str__(self):
        ...
        for name in dir(self):
            ...
            elif not cls_definition: # Items only on instnace, not on class
                data[name] = getattr(self, name)
        return str(data)
    ...
    def emit_updated(self):
        ...
        # XXX(oanson) This should be done in df_local_controller, not here:
