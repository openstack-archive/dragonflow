...
import dragonflow.db.model_proxy as mp
from dragonflow.db import models2 as models


@mf.register_model
@mf.construct_nb_db_model
class PortPair(models.NbModelBase, models.NameMixin):
...
@mf.register_model
@mf.construct_nb_db_model
class PortPairGroup(models.NbModelBase, models.NameMixin):
    table_name = 'sfc_portpairgroup'

    port_pairs = fields.ListField(mp.create_model_proxy(PortPair))


@mf.register_model
@mf.construct_nb_db_model
class FlowClassifier(models.NbModelBase,
                     models.NameMixin,
...
@mf.register_model
@mf.construct_nb_db_model
class PortChain(models.NbModelBase, models.NameMixin):
    table_name = 'sfc_portchain'

    protocol = df_fields.EnumField(['mpls', 'nsh'])
    chain_id = fields.IntField()
    port_pair_groups = fields.ListField(mp.create_model_proxy(PortPairGroup))
    flow_classfiers = fields.ListField(mp.create_model_proxy(FlowClassifier))
