...
RESOURCE_ML2_QOS_POLICY_UPDATE = 6
RESOURCE_ML2_QOS_POLICY_DELETE = 7
...
def _get_lock_id_by_resource_type(type, *args, **kwargs):
    ...
    elif RESOURCE_ML2_QOS_POLICY_UPDATE == type:
        lock_id = args[0][1]['tenant_id']
    elif RESOURCE_ML2_QOS_POLICY_DELETE == type:
        # when delete qos policy, there's no tenant_id in rpc message.
