...
class RedisPublisherAgent(pub_sub_api.PublisherApi):
    ...
    def initialize(self):
        ...
        self.redismgt = RedisMgt.get_instance(cfg.CONF.df.remote_db_ip, cfg.CONF.df.remote_db_port)
        ...
        while True:
            ...
            try:
                ...
                try:
                    ...
                    LOG.exception(_LE("fix connection failed %(ip)s: %(port)s")
                                  % {'ip': self.ip, 'port': self.plugin_updates_port})
