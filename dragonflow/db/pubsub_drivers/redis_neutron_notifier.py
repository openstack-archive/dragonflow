...
class RedisNeutronNotifier(neutron_notifier_api.NeutronNotifierDriver):
    # RedisNeutronNotifier implements notification mechanism from
    # Dragonflow controller to northbound neutron server, based on redis
    ...
    def initialize(self, nb_api, is_neutron_server=False):
        ...
        if is_neutron_server:
            ...
            if not cfg.CONF.df.enable_df_pub_sub:
                LOG.warning("RedisNeutronNotifier cannot "
