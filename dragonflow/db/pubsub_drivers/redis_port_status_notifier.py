...
from dragonflow.db.port_status_api import PortStatusDriver
...
class RedisPortStatusNotifier(PortStatusDriver):
    ...
    def initialize(self, mech_driver, nb_api, pub_sub,
