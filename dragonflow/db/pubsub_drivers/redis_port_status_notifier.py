...
class RedisPortStatusNotifier(port_status_api.PortStatusDriver):
    ...
    def _send_port_status_event(self, table, key, action, value):
        listeners = self.nb_api.get_all_neutron_listener()
    ...
    def start_subscriber(self):
        ...
        # TODO(wangjian): df-controllers can sort neutron-listeners by timestamp,
        # so that it can avoid to choose a dead neutron-listerner as far as possible
