...
class DFMechDriver(driver_api.MechanismDriver):
    ...
    def create_heart_beat_reporter(self, host):
        ...
        if listener is None:
            ...
            # FIXME(wangjian): if api_worker is 1, the old ppid is equal
            # to my_ppid. I tried to set api_worker=1, but still more than one
    ...
    def _create_heart_beat_reporter(self, host):
        ...
        self.nb_api.subscriber.register_topic('n_listener_' + host)
