...
class DFMechDriver(driver_api.MechanismDriver):
    ...
    def update_security_group(self, resource, event, trigger, **kwargs):
        ...
        if event == events.AFTER_CREATE:
            self.nb_api.create(secgroups.SecurityGroup(id=sg_id,
                                                       topic=tenant_id,
                                                       name=sg_name,
                                                       rules=rules,
                                                       version=sg_version))
            ...
            self.nb_api.update(secgroups.SecurityGroup(id=sg_id,
                                                       topic=tenant_id,
                                                       name=sg_name,
                                                       rules=rules,
                                                       version=sg_version))
    ...
    def delete_security_group(self, resource, event, trigger, **kwargs):
        ...
        self.nb_api.delete(secgroups.SecurityGroup(id=sg['id']))
    ...
    def create_security_group_rule(self, resource, event, trigger, **kwargs):
        ...
        print("calling add rules")
        sg.add_rules([secgroups.SecurityGroupRule(sg_rule)])
