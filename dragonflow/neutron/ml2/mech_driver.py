...
class DFMechDriver(driver_api.MechanismDriver):
    ...
    def update_port_postcommit(self, context):
        ...
        # TODO (KANG)here we don not want port status update to trigger
        # sending event to other compute node.
        if (updated_port['device_owner'] != n_const.DEVICE_OWNER_ROUTER_GW
                and updated_port['device_owner'] != n_const.DEVICE_OWNER_DHCP
