        ...
        if sg_rule and sg_id:
            ...
            with nb_lock:
                ...
                try:
                    ...
                    LOG.warning(BAD_VERSION_MESSAGE % {'id': sg_id})
        return sg_rule
        ...
        if new_subnet and net_id:
            ...
            with nb_lock:
                ...
                try:
                    ...
                    LOG.warning(BAD_VERSION_MESSAGE % {'id': net_id})
        return new_subnet
        ...
        if 'name' in network['network']:
            ...
            with nb_lock:
                ...
                try:
                    ...
                    LOG.warning(BAD_VERSION_MESSAGE % {'id': network_id})
        return result
        ...
        with nb_lock:
            ...
            try:
                self.nb_api.add_lrouter_port(port['id'],
                    ...
                    LOG.warning(BAD_VERSION_MESSAGE % {'id': router_id})
        return result
        ...
        with nb_lock:
            ...
            try:
                self.nb_api.update_floatingip(
                    ...
                    LOG.warning(BAD_VERSION_MESSAGE % {'id': id})
