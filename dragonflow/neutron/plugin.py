...
class DFPlugin(db_base_plugin_v2.NeutronDbPluginV2,
    ...
    def create_security_group_rule(self, context, security_group_rule):
        ...
        if sg_rule and sg_id and old_version:
    ...
    def create_subnet(self, context, subnet):
        ...
        if new_subnet and net_id and dhcp_address and old_version:
    ...
    def update_network(self, context, network_id, network):
        ...
        if 'name' in network['network'] and old_version:
            nb_lock = lock_db.DFDBLock(context, network_id)
            with nb_lock:
