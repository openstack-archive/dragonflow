...
from dragonflow.db.neutron import versionedobject_db as vo_db
...
class DFPlugin(db_base_plugin_v2.NeutronDbPluginV2,
    ...
    def create_security_group(self, context, security_group,
        ...
        with nb_lock:
            self.nb_api.create_security_group(context, sg_name, rules=rules)
        return sg_db
    ...
    def create_security_group_rule(self, context, security_group_rule):
        with db_api.autonested_transaction(context.session):
            ...
            vo_db.increment_version(context, sg_id)

        if sg_rule and sg_id:
            nb_lock = lock_db.DFDBLock(context, sg_id)
            with nb_lock:
                self.nb_api.add_security_group_rules(context, sg_id, [sg_rule])
        return sg_rule
    ...
    def delete_security_group_rule(self, context, id):
        ...
        if sg_id:
            ...
            nb_lock = lock_db.DFDBLock(context, sg_id)
            with nb_lock:
                self.nb_api.delete_security_group_rule(context, sg_id, id)
    ...
    def delete_security_group(self, context, sg_id):
        ...
        nb_lock = lock_db.DFDBLock(context, sg_id)
        with nb_lock:
            self.nb_api.delete_security_group(context, sg_id)
    ...
    def create_subnet(self, context, subnet):
        with db_api.autonested_transaction(context.session):
            ...
            vo_db.increment_version(context, net_id)
    ...
    def delete_subnet(self, context, id):
        ...
        if net_id:
            ...
            with nb_lock:
                try:
                    self.nb_api.delete_subnet(context, net_id, id)
    ...
    def create_network_nb_api(self, context, network):
        ...
        self.nb_api.create_lswitch(context, network['id'],
    ...
    def _set_network_name(self, context, network_id, name):
        ext_id = [df_const.DF_NETWORK_NAME_EXT_ID_KEY, name]
        self.nb_api.update_lswitch(context, network_id,
                                   external_ids=ext_id)
    ...
    def update_network(self, context, network_id, network):
        ...
        with db_api.autonested_transaction(context.session):
            ...
            vo_db.increment_version(context, network_id)
    ...
    def update_port(self, context, id, port):
        with db_api.autonested_transaction(context.session):
            ...
            vo_db.increment_version(context, updated_port['id'])
        ...
        with nb_lock:
            self.nb_api.update_lport(context, updated_port['id'],
    ...
    def delete_port(self, context, port_id, l3_port_check=True):
        ...
        try:
            ...
            with nb_lock:
                self.nb_api.delete_lport(context, port_id, topic=topic)
        except df_exceptions.DBKeyNotFound:
    ...
    def create_router(self, context, router):
        ...
        with nb_lock:
            self.nb_api.create_lrouter(context, router_name,
                                       topic=tenant_id,
                                       external_ids=external_ids,
                                       ports=[])
        return router
    ...
    def delete_router(self, context, router_id):
        ...
        with nb_lock:
            try:
                self.nb_api.delete_lrouter(context, router_name,
    ...
    def add_router_interface(self, context, router_id, interface_info):
        ...
        with db_api.autonested_transaction(context.session):
            ...
            vo_db.increment_version(context, router_id)

        nb_lock = lock_db.DFDBLock(context, router_id)
        with nb_lock:
            lport = self.nb_api.get_logical_port(port['id'])
            self.nb_api.add_lrouter_port(context, port['id'],
                                         lrouter, lswitch,
    ...
    def remove_router_interface(self, context, router_id, interface_info):
        ...
        with nb_lock:
            try:
                self.nb_api.delete_lrouter_port(context, router_id,
                                                network_id)
            except df_exceptions.DBKeyNotFound:
