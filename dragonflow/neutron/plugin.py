...
# the future.
BAD_VERSION_MESSAGE = _LE("The object %(id)s is out-of-sync.")
        ...
        if sg_rule and sg_id:
            ...
            with nb_lock:
                ...
                try:
                    ...
                    LOG.exception(BAD_VERSION_MESSAGE % {'id': sg_id})
        return sg_rule
        ...
        if new_subnet and net_id:
            ...
            with nb_lock:
                ...
                try:
                    ...
                    LOG.exception(BAD_VERSION_MESSAGE % {'id': net_id})
        return new_subnet
        ...
        if 'name' in network['network']:
            ...
            with nb_lock:
                ...
                try:
                    ...
                    LOG.exception(BAD_VERSION_MESSAGE % {'id': network_id})
        return result
        ...
        with nb_lock:
            ...
            try:
                self.nb_api.update_lport(name=updated_port['id'],
                    ...
                    LOG.exception(BAD_VERSION_MESSAGE % {'id':
                                                         updated_port['id']})
        return updated_port
        ...
        with nb_lock:
            ...
            try:
                self.nb_api.add_lrouter_port(port['id'],
                    ...
                    LOG.exception(BAD_VERSION_MESSAGE % {'id': router_id})
        return result
        ...
        with nb_lock:
            ...
            try:
                self.nb_api.update_floatingip(
                    ...
                    LOG.exception(BAD_VERSION_MESSAGE % {'id': id})
