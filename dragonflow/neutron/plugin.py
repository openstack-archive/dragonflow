...
class DFPlugin(db_base_plugin_v2.NeutronDbPluginV2,
    ...
    def delete_security_group_rule(self, context, id):
        ...
        self.nb_api.delete_security_group_rule(sg_id, id, sg_group['tenant_id'])
    ...
    def _set_network_name(self, network_id, name, topic):
        ext_id = [df_const.DF_NETWORK_NAME_EXT_ID_KEY, name]
        self.nb_api.update_lswitch(network_id, topic,
                                   external_ids=ext_id)
