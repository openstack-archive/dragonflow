...
class DFL3RouterPlugin(service_base.ServicePluginBase,
    ...
    def _start_rpc_notifiers(self):
        ...
        self.agent_notifiers[const.AGENT_TYPE_L3] = {
            l3_rpc_agent_api.L3AgentNotifierAPI()
        }
    ...
    def start_rpc_listeners(self):
        ...
        self.agent_notifiers.update(
            {const.AGENT_TYPE_L3: l3_rpc_agent_api.L3AgentNotifierAPI()})
    ...
    def delete_floatingip(self, context, id):
        ...
        try:
            ...
            LOG.exception(_LE("floatingip %s is not found in DF DB"
                              "might have been deleted concurrently") % id)
