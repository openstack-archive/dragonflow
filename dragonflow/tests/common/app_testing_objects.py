...
class Subnet(object):
    ...
    def create_port(self, integration_bridge, security_groups=None):
...
class Port(object):
    ...
    device
    """
    def __init__(self, subnet, port_id, integration_bridge,
        ...
        :param integration_bridge: The bridge that the port is attached
        :type integration_bridge: String - bridge name
        """
        self.subnet = subnet
        ...
        self.tap = LogicalPortTap(self.port, integration_bridge)
