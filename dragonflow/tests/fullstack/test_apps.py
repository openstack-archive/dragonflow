...
class TestSGApp(test_base.DFTestBase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.security_group2 = security_group2
            self.security_group3 = security_group3
    ...
    def _update_policy(self):
        ...
        port_policies = self._create_port_policies(self.ethertype)
    ...
    def _create_port_policies(self, ethertype='IPv4'):
        raise_action = app_testing_objects.RaiseAction("Unexpected packet")
        ...
        rules1 = [
            app_testing_objects.PortPolicyRule(
                ...
                app_testing_objects.RyuICMPPongFilter(
                    self.permit_icmp_request, ethertype=ethertype),
                actions=[
                    app_testing_objects.DisableRuleAction(),
                    app_testing_objects.StopSimulationAction(),
                ]
