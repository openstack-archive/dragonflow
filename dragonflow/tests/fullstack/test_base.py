...
class DFTestBase(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.nb_api.set_db_change_callback(self._db_change_handler)
        ...
        self.vswitch_api.initialize(self._db_change_handler)
    ...
    def _db_change_handler(self, table, key, action, value, topic=None):
