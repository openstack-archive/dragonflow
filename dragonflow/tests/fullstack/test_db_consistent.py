...
class TestDbConsistent(test_base.DFTestBase):
    ...
    def test_db_consistent(self):
        ...
        self.addCleanup(object.close_test_obj, network)
        ...
        self.addCleanup(object.close_test_obj, subnet)
        ...
        self.addCleanup(object.close_test_obj, vm)
        ...
        self.addCleanup(self.nb_api.driver.create_key, 'lswitch',
                        net_id, topic)
