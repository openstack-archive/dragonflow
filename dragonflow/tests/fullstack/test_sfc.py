...
IPV4_CIDR = '192.168.12.0/24'
IPV6_CIDR = '2001:db8::1/64'

SRC_IPV4_1 = '192.168.12.11'
SRC_IPV4_2 = '192.168.12.12'
DST_IPV4_1 = '192.168.12.21'
DST_IPV4_2 = '192.168.12.22'

SRC_IPV6_1 = '2001:db8::11'
SRC_IPV6_2 = '2001:db8::12'
DST_IPV6_1 = '2001:db8::21'
DST_IPV6_2 = '2001:db8::22'
...
class SfcTestsCommonBase(test_base.DFTestBase,
    ...
    def setUp(self):
        ...
        self.subnet = self.topology.create_subnet(IPV4_CIDR)
        self.subnet_ipv6 = self.topology.create_subnet(IPV6_CIDR)
    ...
    def _gen_ipv6(self, nxt, src=None, dst=None):
        return ipv6.ipv6(
            src=(src or SRC_IPV6_2),
            dst=(dst or DST_IPV6_2),
            nxt=nxt,
        )
...
def _make_scenario(name, **kwargs):
    return (
        name,
        {
            'pkt_ipver': kwargs.get('pkt_ipver', 4),
            'pkt_proto': kwargs.get('pkt_proto', 'UDP'),
...
class TestFcApp(SfcTestsCommonBase):
    ...
    def _fc_params(self):
        ...
        if self.fc_ip_src is not None:
            self['source_ip_prefix'] = self.fc_ip_src

        if self.fc_ip_dst is not None:
            self['destination_ip_prefix'] = self.fc_ip_dst
    ...
    def _initial_packet(self):
        ...
        if self.pkt_proto.upper() == 'TCP':
            tp = self._gen_tcp()
            proto = inet.IPPROTO_TCP
        elif self.pkt_proto.upper() == 'UDP':
            tp = self._gen_udp()
