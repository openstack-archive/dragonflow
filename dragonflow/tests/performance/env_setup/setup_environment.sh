...
do
	...
	nova add-secgroup iPerf-client$i default
	...
	nova add-secgroup iPerf-server$j default
	let "j++"
	echo -e "==========\nCreating iPerf-server$j VM on $controllerNode\n=========="
...
do
	...
	#python create_VM.py iPerf-server$j private1 $computeNode
	...
	let "j++"
	echo -e "==========\nCreating iPerf-server$j VM on $computeNode\n=========="
	#python create_VM.py iPerf-server$j private2 $computeNode
