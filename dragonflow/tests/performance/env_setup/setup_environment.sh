...
neutron security-group-rule-create --protocol tcp --port-range-min 8686 --port-range-max 8686 --direction ingress --remote-ip-prefix 0.0.0.0/0 sg1
neutron security-group-rule-create --protocol tcp --port-range-min 1 --port-range-max 65000 --direction ingress --remote-ip-prefix 0.0.0.0/0 sg1
