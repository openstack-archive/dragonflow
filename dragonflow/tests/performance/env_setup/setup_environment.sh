...
neutron security-group-rule-create --protocol icmp --direction ingress --remote-group-id sg1 sg1
neutron security-group-rule-create --protocol tcp --port-range-min 1 --port-range-max 65535 --direction ingress --remote-group-id sg1 sg1
