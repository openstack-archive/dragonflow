...
echo -e "========================================\n"
echo "Link to the test report: $dirname/report/data_plane_report.html"
echo "You can copy the report directory ($dirname/report/) and run the html file on any web server"
echo -e "========================================\n"
