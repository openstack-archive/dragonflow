...
class TestLogicalNetworks(tests_base.BaseTestCase):
    ...
    def test_add_remove_local_port(self):
        fake_local_vlan_port1 = _test_app_base.make_fake_local_port(
                network_type='vlan',
        ...
        fake_local_vlan_port2 = _test_app_base.make_fake_local_port(
                network_type='vlan',
        ...
        fake_local_gre_port1 = _test_app_base.make_fake_local_port(
                network_type='gre',
    ...
    def test_add_remove_remote_port(self):
        fake_remote_vlan_port1 = _test_app_base.make_fake_remote_port(
                network_type='vlan',
        ...
        net_1_vlan_ports = self.logical_networks.get_remote_port_count(
                ...
                network_type='vlan')
        self.assertEqual(1, net_1_vlan_ports)
        fake_remote_vlan_port2 = _test_app_base.make_fake_remote_port(
                network_type='vlan',
        ...
        net_2_gre_ports = self.logical_networks.get_remote_port_count(
                ...
                network_type='gre')
        self.assertEqual(0, net_2_gre_ports)
        fake_local_gre_port1 = _test_app_base.make_fake_remote_port(
                network_type='gre',
                lswitch='fake_gre_switch1',
