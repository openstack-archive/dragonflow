...
class TestDHCPApp(_test_app_base.DFAppTestBase):
    ...
    def test_update_dhcp_ip_subnet_redownload_dhcp_unicast_flow(self):
        ...
        self.app._install_dhcp_unicast_match_flow.assert_called_once_with(
            '10.0.0.100', _test_app_base.fake_logic_switch1.get_unique_key())
        self.app._remove_dhcp_unicast_match_flow.assert_called_once_with(
            _test_app_base.fake_logic_switch1.get_unique_key(), '10.0.0.2')

    def test__get_lswitch_by_port(self):
        lport = _test_app_base.fake_local_port1
        l_switch_id = lport.get_lswitch_id()
        fake_lswitch = _test_app_base.fake_logic_switch1
    ...
    def test__get_subnet_by_port(self):
        fake_lport = copy.deepcopy(_test_app_base.fake_local_port1)
        fake_lport_subnet = _test_app_base.fake_logic_switch1.get_subnets()[0]
    ...
    def test_gateway_include_port_dhcp_opt_3(self):
        subnet = copy.copy(_test_app_base.fake_logic_switch1.get_subnets()[0])
