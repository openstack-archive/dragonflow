...
class TestL2App(app_test_base.DFAppTestBase):
    apps_list = "l2_app.L2App"

    def setUp(self):
        super(TestL2App, self).setUp()
        fake_local_switch1 = app_test_base.make_fake_logic_switch(
    ...
    def test_multicast_local_port(self):
        fake_local_port1 = app_test_base.make_fake_local_port(
                network_type='local',
        ...
        fake_local_port2 = app_test_base.make_fake_local_port(
                network_type='local',
                lswitch='fake_local_switch1',
