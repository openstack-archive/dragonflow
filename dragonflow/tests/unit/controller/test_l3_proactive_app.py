...
class TestL3ProactiveApp(_test_app_base.DFAppTestBase,
    ...
    def test_add_local_port(self):
        # add local port
        self._test_add_port(_test_app_base.fake_local_port1)

    def test_remove_local_port(self):
        self._test_remove_port(_test_app_base.fake_local_port1)

    def test_add_remote_port(self):
        # add remote port
        self._test_add_port(_test_app_base.fake_remote_port1)

    def test_remove_remote_port(self):
        self._test_remove_port(_test_app_base.fake_remote_port1)
