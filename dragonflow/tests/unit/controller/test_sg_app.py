...
class TestSGApp(app_test_base.DFAppTestBase):
    ...
    def setUp(self):
        ...
        self.security_group = app_test_base.fake_security_group
        self.fake_local_lport = app_test_base.fake_local_port1
        self.fake_remote_lport = app_test_base.fake_remote_port1
