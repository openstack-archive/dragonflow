...
class TestTopology(_test_app_base.DFAppTestBase):
    ...
    def test_vm_port_online_offline(self):
        self.nb_api.get_all_logical_switches.return_value = [
            _test_app_base.fake_logic_switch1]
        self.nb_api.get_all_logical_ports.return_value = [
            _test_app_base.fake_local_port1]
        ...
        # Verify port online
        self.topology.ovs_port_updated(_test_app_base.fake_ovs_port1)
        self.controller.update_lport.assert_called_once_with(
            _test_app_base.fake_local_port1)
        self.nb_api.subscriber.register_topic.assert_called_once_with(
            _test_app_base.fake_local_port1.get_topic())

        # Verify port offline
        self.nb_api.get_all_logical_ports.return_value = []
        self.topology.ovs_port_deleted(_test_app_base.fake_ovs_port1.get_id())
        self.controller.delete_lport.assert_called_once_with(
            _test_app_base.fake_local_port1.get_id())
    ...
    def test_vm_online_after_topology_pulled(self):
        ...
        def _get_logical_port(lport_id, topic):
            if lport_id == _test_app_base.fake_local_port1.get_id():
                return _test_app_base.fake_local_port1
            if lport_id == _test_app_base.fake_local_port2.get_id():
                return _test_app_base.fake_local_port2
        ...
        self.nb_api.get_all_logical_ports.return_value = [
            _test_app_base.fake_local_port1,
            _test_app_base.fake_local_port2]
        self.controller.update_lport = mock.Mock()
        self.topology.ovs_port_updated(_test_app_base.fake_ovs_port2)
        self.controller.update_lport.assert_called_once_with(
            _test_app_base.fake_local_port2)
    ...
    def test_multi_vm_port_online_restart_controller(self):
        ...
        calls = [mock.call(_test_app_base.fake_local_port1),
                 mock.call(_test_app_base.fake_local_port2)]
    ...
    def test_check_topology_info(self):
        ...
        self.topology.ovs_ports = {
            'fake_ovs_port1': _test_app_base.fake_ovs_port1
        }
        ...
        self.controller.db_store.set_port(
            _test_app_base.fake_local_port1.get_id(),
            _test_app_base.fake_local_port1, True, topic)
    ...
    def test_db_sync(self):
        ...
        self.topology.topic_subscribed = {
            'fake_tenant1': _test_app_base.fake_local_port1}
        self.controller.update_lport = mock.Mock()
