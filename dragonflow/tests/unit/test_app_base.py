...
fake_ovs_port1.get_type.return_value = api_nb.OvsPort.TYPE_VM
...
fake_local_port2 = api_nb.LogicalPort("{}")
fake_local_port2.lport = {
    'subnets': ['fake_subnet1'],
    'binding_profile': {},
...
fake_ovs_port2.get_type.return_value = api_nb.OvsPort.TYPE_VM
