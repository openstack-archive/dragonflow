...
class DFAppTestBase(tests_base.BaseTestCase):
    ...
    def setUp(self, enable_selective_topo_dist=False):
        ...
        self.vswitch_api = \
            self.controller.switch_backend.vswitch_api = mock.MagicMock()
        kwargs = dict(
            nb_api=self.controller.nb_api,
            vswitch_api=self.vswitch_api
        )
        self.controller.switch_backend.open_flow_app =\
            ryu_base_app.RyuDFAdapter(
                db_change_callback=self.controller.db_change_callback,
                **kwargs)
        self.open_flow_app = self.controller.switch_backend.open_flow_app
