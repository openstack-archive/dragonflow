...
class TestDfController(test_app_base.DFAppTestBase):
    ...
    def setUp(self):
        ...
        self.lport1 = models.LogicalPort(self.lport1_value)
        self.lswitch1 = models.LogicalSwitch(self.lswitch1_value)
	...
	self.controller.nb_api.clear_lport_migration.assert_called_with(
            self.lport1.get_id())
