...
class TestDBConsistent(tests_base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.controller.open_flow_app = mock.MagicMock()
        self.topology = self.controller.topology = mock.MagicMock()
        self.db_store = self.controller.db_store = mock.MagicMock()
