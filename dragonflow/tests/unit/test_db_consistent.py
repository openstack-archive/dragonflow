...
class TestDBConsistent(tests_base.BaseTestCase):
    ...
    def test_check_topology_info(self):
        ...
        self.topology._del_from_topic_subscribed.assert_called_with(
    ...
    def test_db_comparison(self):
        df_obj1 = Mock()
        df_obj1.get_id.return_value = self.lport_id1
        df_obj1.get_version.return_value = 1

        df_obj2 = Mock()
        df_obj2.get_id.return_value = self.lport_id2
        df_obj2.get_version.return_value = 2

        local_obj1 = Mock()
        local_obj1.get_id.return_value = self.lport_id2
        local_obj1.get_version.return_value = 1

        local_obj2 = Mock()
        local_obj2.get_id.return_value = self.lport_id3
        local_obj2.get_version.return_value = 1
