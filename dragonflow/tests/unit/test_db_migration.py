...
VersionMod = collections.namedtuple(
    'VersionMod', ('DESCRIPTION', 'DATE', 'upgrade'))
...
class DBMigrationTestCase(tests_base.BaseTestCase):
    ...
    def test_get_sorted_all_version_modules(self, load_source, listdir):
        ...
        def load_source_func(filename, path):
            if filename == 'mod1':
                return VersionMod('mod1', '2017-08-23 00:00', None)

            elif filename == 'mod3':
                return VersionMod('mod3', '2017-07-23 00:00', None)
            else:
    ...
    def test_set_db_version_to_latest(self, set_db_migration_metadata,
        ...
        mod1 = VersionMod('mod1', '2017-08-23 00:00', None)
        mod2 = VersionMod('mod1', '2017-08-24 00:00', None)
    ...
    def test_set_db_migration_metadata(self):
        ...
        db_driver.set_key.assert_called_once_with(
            ...
            ('{"date": "2017-08-23 00:00", "description": "mod1"}'))
    ...
    def test_migrate_database(self, get_current_db_date,
        ...
        mod1 = VersionMod('mod1', '2017-08-23 00:00', mock.Mock())
        mod2 = VersionMod('mod1', '2017-08-23 12:00', mock.Mock())
        mod3 = VersionMod('mod1', '2017-08-23 18:00', mock.Mock())
        mod4 = VersionMod('mod1', '2017-08-23 23:00', mock.Mock())
