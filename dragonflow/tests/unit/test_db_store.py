...
class TestDbStore(tests_base.BaseTestCase):
    ...
    def test_chassis(self):
        ...
        chassis1 = models2.Chassis(**chassis1_params)
        chassis2 = models2.Chassis(**chassis2_params)
        self.db_store2.update(chassis1)
        self.db_store2.update(chassis2)
        self.assertEqual(
            chassis1,
            self.db_store2.get_one(models2.Chassis(**chassis1_params))
        )
        self.assertEqual(
            chassis2,
            self.db_store2.get_one(models2.Chassis(**chassis2_params))
        )
        self.db_store2.delete(models2.Chassis(**chassis1_params))
        self.assertIsNone(self.db_store2.get_one(
            models2.Chassis(**chassis1_params)))

        self.db_store2.delete(models2.Chassis(**chassis2_params))
        self.assertIsNone(self.db_store2.get_one(
            models2.Chassis(**chassis2_params)))
