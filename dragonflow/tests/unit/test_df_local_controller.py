...
class DfLocalControllerTestCase(test_app_base.DFAppTestBase):
    ...
    def test_lport_lswitch_external(self):
        ...
        lport.set_external_value.assert_called_with('local_network_id', '10')
        lport.set_external_value.assert_called_with('network_type', 'vxlan')
        lport.set_external_value.assert_called_with('segmentation_id', 5000)
