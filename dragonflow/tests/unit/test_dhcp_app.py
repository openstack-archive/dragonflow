...
class TestDHCPApp(test_app_base.DFAppTestBase):
    ...
    def test_update_dhcp_subnet_redownload_dhcp_flow(self):
        ...
        orig_fake_lswitch = copy.copy(fake_lswitch)
        ...
        print(self.app._install_dhcp_flow_for_vm_port.call_args_list)
        ...
        test_app_base.fake_logic_switch1 = orig_fake_lswitch
