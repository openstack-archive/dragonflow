...
class TestDHCPApp(test_app_base.DFAppTestBase):
    ...
    def test_update_dhcp_subnet_redownload_dhcp_flow(self):
        ...
        fake_lswitch.lswitch['subnets'][0]['enable_dhcp'] = False
        fake_lswitch.lswitch['subnets'][0]['dhcp_ip'] = None
        # Bump the version to pass the version check
        fake_lswitch.lswitch['version'] += 1
        ...
        fake_lswitch1.lswitch['subnets'][0]['enable_dhcp'] = True
        fake_lswitch1.lswitch['subnets'][0]['dhcp_ip'] = "10.0.0.2"
        # Bump the version to pass the version check
        fake_lswitch1.lswitch['version'] += 1
