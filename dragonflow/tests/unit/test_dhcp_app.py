...
class TestDHCPApp(test_app_base.DFAppTestBase):
    ...
    def _build_dhcp_test_fake_lport(self, extra_dhcp_opts=None):
    ...
    def test_dhcp_request_parmas_response(self):
        ...
        fake_loprt = self._build_dhcp_test_fake_lport(extra_dhcp_opts)
        ...
        # don't on parameter that not requested
