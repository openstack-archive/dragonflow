...
class TestDFMechDriver(base.BaseTestCase):
    ...
    def test_create_network_postcommit(self):
        ...
        network_context = self._get_network_context(tenant_id, network_id,
                                                    segmentation_id)
        external_ids = {'neutron:network_name': u'FakeNetwork'}
    ...
    def test_delete_network_postcommit(self):
        ...
        self.driver.nb_api.delete_lswitch.assert_called_with(
            name=network_id, topic=tenant_id)
    ...
    def test_create_subnet_postcommit(self):
        ...
        self.driver._get_subnet_dhcp_port_address = mock.Mock(
            return_value=dhcp_ip)
    ...
    def test_create_port_postcommit(self):
        ...
        tunnel_key = '9999'
        external_ids = {'neutron:port_name': u'FakePort'}
        ...
        self.driver.nb_api.create_lport.assert_called_with(
            name=port_id, lswitch_name=network_id, topic=tenant_id,
            macs=['aabb'], ips=['10.0.0.1'], external_ids=external_ids,
            parent_name=None, tag=None, enabled=True, chassis=None,
            tunnel_key=tunnel_key, port_security=allowed_macs,
            device_owner='compute', sgids=None)
    ...
    def test_update_port_postcommit(self):
        ...
        self.driver.nb_api.update_lport.assert_called_with(
            name=port_id, topic=tenant_id,
            macs=['aabb'], ips=['10.0.0.1'], external_ids=external_ids,
            parent_name=None, tag=None, enabled=True, chassis=None,
            port_security=allowed_macs, security_groups=None,
    ...
    def test_create_security_group(self):
        ...
        kwargs = self._get_security_group_kwargs(tenant_id, sg_id, rules)
        ...
        self.driver.nb_api.create_security_group.assert_called_with(
            name=sg_id, topic=tenant_id, rules=rules)
    ...
    def test_create_security_group_rule(self):
        ...
        kwargs = self._get_security_group_rule_kwargs(rule, None, None)
    ...
    def test_delete_security_group_rule(self):
        ...
        securitygroups_db.SecurityGroupDbMixin.get_security_group_rule = \
    ...
    def _get_security_group_kwargs(self, tenant_id, sg_id, rules):
