...
class TestRyuDFAdapter(tests_base.BaseTestCase):
    ...
    def test_notifies(self):
        ...
        self.ryu_df_adapter.notify_update_lswitch(lswitch=1)
        self.ryu_df_adapter.notify_delete_lswitch(lswitch=2)
        ...
        self.ryu_df_adapter.notify_update_lrouter(router=7, original_router=0)
        self.ryu_df_adapter.notify_delete_lrouter(router=8)
        ...
        self.mock_app.assert_has_calls([
                ...
                mock.call.remove_lswitch(lswitch=2),
