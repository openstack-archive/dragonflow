...
from dragonflow.controller import topology as tp
...
class TestTopology(tests_base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.mock_nb_api = mock.Mock(name="nb_api")
        self.mock_openflow_app = mock.Mock(name="openflow_app")

        mock_controller = mock.Mock(name="controller")
        ...
        self.topology = tp.Topology(self.mock_controller, True)
        ...
        self.ovs_port1 = api_nb.OvsPort(value1)
        ...
        self.lport1 = api_nb.LogicalPort(self.lport1_value)
        self.lswitch1 = api_nb.LogicalSwitch(self.lswitch1_value)
