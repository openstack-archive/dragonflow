...
class TestTrunkApp(test_app_base.DFAppTestBase):
    ...
    def setUp(self):
        ...
        self.db_store2.update(test_app_base.fake_local_port2)
    ...
    def test_delete_child_segmentation(self):
        lswitch2 = self._create_2nd_lswitch()
        self.db_store2.update(lswitch2)
        lport = self._create_child_port()
        self.db_store2.update(lport)
        segmentation = self._create_segmentation()
        self.db_store2.update(segmentation)
    ...
    def test__get_classification_match(self):
        ...
        self.assertEqual({'in_port': 3, 'vlan_vid': 7}, match_dict)
    ...
    def test__get_dispatch_actions(self):
        ...
        self.assertEqual({0: 3, 1: self.app.ofproto.OFPCML_NO_BUFFER},
                         actions[2]._dict)
