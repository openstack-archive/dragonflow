...
class TestZMQPubSub(tests_base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.ZMQPublisherAgent.context.socket = mock.Mock()
        self.ZMQPublisherAgent.context.socket.setsockopt = mock.Mock()
        self.ZMQPublisherAgent.context.socket.bind = mock.Mock()
        self.ZMQPublisherAgent.context.socket.send_multipart = mock.Mock()
        self.ZMQSubscriberAgent.context = mock.Mock()
        self.ZMQSubscriberAgent.context.socket = mock.Mock()
        self.ZMQSubscriberAgent.context.socket.connect = mock.Mock()
    ...
    def test_subscribe_success(self):
        ...
        self.assertTrue(
            b'teststring' in self.ZMQSubscriberAgent.topic_list)
        self.assertIsNone(result)
